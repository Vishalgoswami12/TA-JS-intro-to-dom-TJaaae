...
let svtn=document.querySelector('.seventeen')
svtn.style.display="none"
// Change the border of all the hr element from solid to dashed type
let dash =allHrsArray.forEach(ele=>{
...
let rmv=document.querySelector('.one')
rmv.innerHTML = ""
...
*/
let sixtn=document.querySelector('.sixteen')
sixtn.parentNode
sixtn.childNodes
sixtn.previousSibling
sixtn.nextSibling
sixtn.firstChild
sixtn.lastChild
sixtn.previousElementSibling
sixtn.nextElementSibling
sixtn.firstElementChild
sixtn.lastElementChild
// Select box 2 and append a new paragraph element with content "Append inserts as last child" just after hr element.
let two=document.querySelector('.two');
let para2=document.createElement('p');
let inner = para2.innerText="Append inserts as last child" 
two.append(para2);
...
two.classList.toggle('awsesome-box')
...
whole.style.backgroundColor='bisque'
...
imgElm.src=`https://unsplash.com/photos/pb7LEh-AUvw`
...
five.append(anchorOne,anchorTwo)
